...
public class terminal_character_builder extends script.base_script
{
    ...
    public int OnObjectMenuSelect(obj_id self, obj_id player, int item) throws InterruptedException
    {
        ...
        {
            if(hasObjVar(player,"development_mode") || checkConfigSetting("builderEnabled")){
                startCharacterBuilder(player);
            }else{
                sendSystemMessageTestingOnly(player, "This is the live server and the character creation terminal is disabled. Development has been informed.");
                setObjVar(player,"cheaterFlag","1");
            }
        }
        return SCRIPT_CONTINUE;
    }
