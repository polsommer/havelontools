package script.swgplus_scripts.vehicle_system;
...
public class battlefield_vehicle extends script.base_script
{
    ...
    public int OnAttach(obj_id self) throws InterruptedException
    {
        ...
        detachScript(self, "swgplus_scripts.vehicle_system.vehicle_base");
        detachScript(self, "swgplus_scripts.vehicle_system.vehicle_ping");
