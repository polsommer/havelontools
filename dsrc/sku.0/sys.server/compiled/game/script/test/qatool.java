...
public class qatool extends script.base_script
{
    ...
    public int OnAttach(obj_id self) throws InterruptedException
    {
        if (isGod(self))
        {
            if (getGodLevel(self) < 50 || !hasObjVar(self,"development_mode"))
            {
                detachScript(self, "test.qatool");
                sendSystemMessage(self, "You do not have the appropriate access level to use this script. Development has been informed.", null);
            }
            else 
            {
