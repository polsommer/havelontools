...
public class terminal_frs_voting extends script.base_script
{
  ...
  "class_chronicles_master"
    ...
    public static final String[] Jedi_Sys_OPTIONS = {
        "Jedi  Consular  Robe",
        "Elder  Jedi  ARB  Robe",
        "Jedi  Council  Robe"
    };
  ...
  "Master Chronicles"
    ...
    public int handleWeaponOptions(obj_id self, dictionary params) throws InterruptedException
    {
        ...
        {
            case 0:
            refreshMenu(player, "Select the desired weapon option", "Test Center Terminal", Jedi_Sys_OPTIONS, "handlePistolSelect", false);
            break;
            case 1:
    ...
    public int handlePistolSelect(obj_id self, dictionary params) throws InterruptedException
    {
        ...
        if (idx == -1 || idx > Jedi_Sys_OPTIONS.length)
        {
            cleanScriptVars(player);
            return SCRIPT_CONTINUE;
        }
        ...
        {
            case 0:
      theSet.add(static_item.createNewItemFunction("item_jedi_robe_light_04_03", pInv));
            break;
            case 1:
      theSet.add(static_item.createNewItemFunction("item_jedi_robe_light_04_04", pInv));
            break;
            case 2:
      theSet.add(static_item.createNewItemFunction("item_jedi_robe_light_04_05", pInv));
            break;
            case 3:
    ...
    public int handleCarbineSelect(obj_id self, dictionary params) throws InterruptedException
    {
        ...
        {
            case 0:
      theSet.add(static_item.createNewItemFunction("item_jedi_robe_dark_04_03", pInv));
            break;
            case 1:
      theSet.add(static_item.createNewItemFunction("item_jedi_robe_dark_04_04", pInv));
            break;
            case 2:
      theSet.add(static_item.createNewItemFunction("item_jedi_robe_dark_04_05", pInv));
            break;
            case 3:
    ...
    public int handleStaticItemRequest(obj_id self, dictionary params) throws InterruptedException
    {
        ...
        {
            createObject("object/tangible/terminal/terminal_frs_voting.iff", pInv, "");
